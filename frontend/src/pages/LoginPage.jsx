...
const LoginPage = ({ setActiveTab }) => {
  const { login, loginWithGoogle, resetPassword, activeRole, switchRole } = useAuth();
  ...
  const handleSubmit = (e) => {
    ...
    else if (selectedRole === 'trainer') setActiveTab('trainer_dashboard');
    else if (selectedRole === 'company') setActiveTab('company_dashboard');
    ...
    <div className="min-h-[75vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full glass-card rounded-3xl p-8 space-y-6 border border-gray-200 dark:border-slate-800 shadow-2xl">
        ...
        >
          ...
          <span>Sign In with Google (Gmail Auth)</span>
        </button>
